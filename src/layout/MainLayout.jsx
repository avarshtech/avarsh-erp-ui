...
const MainLayoutInner = () => {
  ...
  const allMenuItems = [
    ...
    },
    {
      ...
      icon: <AppstoreOutlined />,
      label: "Production PO",
      moduleId: "production-po",
      children: [
        { key: "/production-po/list", label: "PPO List" },
        { key: "/production-po/new", label: "New PPO" },
      ],
    },
    {
      key: "/work-orders",
    ...
    },
    {
      ...
      label: "Cutting",
      moduleId: ["cut-order-plan", "fabric-receipt", "fabric-relaxation", "marker-planning",
                 "lay-audit", "tmb-check", "cutting-report", "cut-bundling", "bundle-issue",
                 "panel-issue", "panel-check", "process-return", "recutting",
                 "wastage-reconciliation", "cutting-dashboard"],
      children: [
        { key: "/cutting/dashboard", label: "Dashboard", moduleId: "cutting-dashboard" },
        { key: "/cutting/order-plan/list", label: "Cut Order Plan", moduleId: "cut-order-plan" },
        { key: "/cutting/fabric-receipt/list", label: "Fabric Receipt", moduleId: "fabric-receipt" },
        { key: "/cutting/relaxation/list", label: "Relaxation", moduleId: "fabric-relaxation" },
        { key: "/cutting/marker/list", label: "Marker Planning", moduleId: "marker-planning" },
        { key: "/cutting/lay-audit/list", label: "Lay Audit", moduleId: "lay-audit" },
        { key: "/cutting/tmb-check/list", label: "TMB Check", moduleId: "tmb-check" },
        { key: "/cutting/report/list", label: "Cutting Report", moduleId: "cutting-report" },
        { key: "/cutting/bundling/list", label: "Bundling", moduleId: "cut-bundling" },
        { key: "/cutting/bundle-issue/list", label: "Bundle Issue", moduleId: "bundle-issue" },
        { key: "/cutting/panel-issue/list", label: "Panel Issue", moduleId: "panel-issue" },
        { key: "/cutting/panel-check/list", label: "Panel Check", moduleId: "panel-check" },
        { key: "/cutting/process-return/list", label: "Process Return", moduleId: "process-return" },
        { key: "/cutting/recutting/list", label: "Re-Cutting", moduleId: "recutting" },
        { key: "/cutting/wastage/list", label: "Wastage", moduleId: "wastage-reconciliation" },
      ],
    },
    {
      key: "/sewing",
      icon: <ToolOutlined />,
      label: "Sewing",
      moduleId: ["sewing-dashboard", "sewing-line-master", "sewing-operators", "sam-management",
                 "sewing-plan", "cut-parts-receipt", "hourly-production", "garment-issue",
                 "trim-verification", "measurement-report", "endline-topse",
                 "cut-parts-replacement", "operator-skill-matrix", "incentive-calc",
                 "sewing-quality-dashboard"],
      children: [
        { key: "/sewing/dashboard", label: "Dashboard", moduleId: "sewing-dashboard" },
        { key: "/sewing/lines/list", label: "Sewing Lines", moduleId: "sewing-line-master" },
        { key: "/sewing/operators/list", label: "Operators", moduleId: "sewing-operators" },
        { key: "/sewing/sam/list", label: "SAM Standards", moduleId: "sam-management" },
        { key: "/sewing/plan/list", label: "Production Plan", moduleId: "sewing-plan" },
        { key: "/sewing/cut-parts-receipt/list", label: "Cut Parts Receipt", moduleId: "cut-parts-receipt" },
        { key: "/sewing/hourly/list", label: "Hourly Production", moduleId: "hourly-production" },
        { key: "/sewing/garment-issue/list", label: "Garment Issue", moduleId: "garment-issue" },
        { key: "/sewing/trim-verification/list", label: "Trim Verification", moduleId: "trim-verification" },
        { key: "/sewing/measurement/list", label: "Measurement Report", moduleId: "measurement-report" },
        { key: "/sewing/topse/list", label: "End-line TOPSE", moduleId: "endline-topse" },
        { key: "/sewing/replacement/list", label: "Cut Parts Replacement", moduleId: "cut-parts-replacement" },
        { key: "/sewing/skills", label: "Skill Matrix", moduleId: "operator-skill-matrix" },
        { key: "/sewing/incentive/list", label: "Incentive", moduleId: "incentive-calc" },
        { key: "/sewing/quality-dashboard", label: "Quality Dashboard", moduleId: "sewing-quality-dashboard" },
      ],
    },
    {
      key: "/reports",

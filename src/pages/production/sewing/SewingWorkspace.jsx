...
const SewingWorkspace = () => {
  ...
  const items = useMemo(() => [
    ...
    { key: 'trim-verification', label: 'Trims Verification', children: <TrimVerificationList /> },
    ...
    { key: 'topse', label: 'EndLine Check', children: <TopseList /> },
    { key: 'issue', label: 'Garment Issue to Finishing', children: <GarmentIssueList /> },

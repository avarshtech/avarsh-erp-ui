...
const FinishingPoList = () => {
  ...
  }, [debouncedSearch, status, process, vendor, buyer, dateRange, message, activeBranchId]); // eslint-disable-line react-hooks/exhaustive-deps -- refetch when the working branch (X-Branch-Id) changes

...
const MyHr = lazy(() => import('./pages/ess/MyHr'));
      ...
      <StoreProvider>
        <BrowserRouter>
          ...
          >
            ...
            <Route path="ess" element={<PermissionRoute module="hr-ess" operation="view"><Suspense fallback={<PageSkeleton />}><MyHr /></Suspense></PermissionRoute>} />

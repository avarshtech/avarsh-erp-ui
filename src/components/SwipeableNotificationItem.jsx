...
const NOTIFICATION_TYPE_CONFIG = {
  ...
  EXPDOC_PL_FINALISED: { icon: <FileDoneOutlined />, color: '#22c55e', bg: 'rgba(34, 197, 94, 0.1)' },
  ...
  EXPDOC_INVOICE_FINALISED: { icon: <DollarOutlined />, color: '#22c55e', bg: 'rgba(34, 197, 94, 0.1)' },
